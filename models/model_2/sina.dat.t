...
<<<<<<< HEAD
  30   0   0   0   0   0   0  = nstep,nwave,ifconv,iftime,ifcont,ifbdat,ifje
=======
  10   0   0   0   0   0   0  = nstep,nwave,ifconv,iftime,ifcont,ifbdat,ifje
>>>>>>> 6a585360d22cc65ac2b90cb6ebaa39f363bb6123
 ...
 1.00000E+00                  = 加速係数
 1.00000E-08 0.00000E+00      = ddmin(収束判定値), ddmin(閾値)(%)
   1                          = ntnod(測定節点数)
  1              = 節点番号(6i8)
   0                          = nrotmat                 ! 回転材質数
